<div class="page-header ">
	<div class="page-header-content d-lg-flex">
		<div class="d-flex">
			<h4 class="page-title mb-0" style=" font-size: inherit; ">
				<span class="fw-normal"><a href="{{route('home')}}">{{ trans('page_header.dashboard') }}</a></span>  @yield('page_section') @yield('page_name') 
			</h4>
